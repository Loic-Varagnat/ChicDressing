...
if ( is_home() ) {
	...
	<div id="chic-products"  class="boxed-wrapper clear-fix">
		<h2 class="chic-title">Dernières pièces a prix cassés en achat-vente
		</h2>
		<?php
	...
	<div id="chic-fashionweek-map" class="boxed-wrapper clear-fix" style="margin-top:30px">
		<h2 class="chic-title">La FashionMap de pièces de créateur - été 2022 </h2>
		<iframe src="https://www.google.com/maps/d/embed?mid=1SU-W19k76UkTXASeT7PnGAyDYCY&hl=en_US&ehbc=2E312F" width="100%" height="480" title="Carte Google Maps montrant la Fashion Week"></iframe>
			';
	</div>
	<?php
